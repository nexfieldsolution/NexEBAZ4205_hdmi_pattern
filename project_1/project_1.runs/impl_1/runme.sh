...
HD_PWD='/WORK/FPGA/Training/ZYNQ/EBAZ4205/EBAZ4205_tutorial/tutorials/03_pattern/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_hdmi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_hdmi.tcl -notrace
