...
REM
REM Generated by Vivado on Sat Mar 30 17:32:46 +0900 2024
...
call xsim  pattern_tb_behav -key {Behavioral:sim_1:Functional:pattern_tb} -tclbatch pattern_tb.tcl -log simulate.log
